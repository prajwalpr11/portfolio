...
declare module "@salesforce/schema/Lead.IsPriorityRecord" {
...
declare module "@salesforce/schema/Lead.Lead_Date__c" {
  const Lead_Date__c:any;
  export default Lead_Date__c;
}
